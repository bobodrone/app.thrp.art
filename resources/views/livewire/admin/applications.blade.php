<div class="mx-auto max-w-4xl px-4 py-10">
    <div class="mb-8 flex items-center justify-between">
        <h1 class="font-display text-2xl font-bold text-soil-900">Responder Applications</h1>
    ...
    <p class="font-body text-sm text-soil-500">
        Approving sends an invite. To invite a responder without an application, or to change
        someone's role afterwards, use the <a href="{{ route('admin.users') }}" class="font-semibold text-leaf-600 hover:underline">users page</a>.
    </p>
</div>
