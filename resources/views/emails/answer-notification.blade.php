...
<body style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:40px 24px;color:#111;">
  ...
  <h1 style="font-size:22px;font-weight:700;margin:0 0 12px;">Your question has been answered</h1>
  <p style="color:#444;line-height:1.6;">Hi {{ $askerName }},</p>
  <p style="color:#444;line-height:1.6;">Someone has answered your question!</p>
