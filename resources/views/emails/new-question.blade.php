...
<body style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:40px 24px;color:#111;">
  ...
  <h1 style="font-size:22px;font-weight:700;margin:0 0 12px;">New question waiting for a response</h1>
  <p style="color:#444;line-height:1.6;">Hi {{ $creatorName }},</p>
  <p style="color:#444;line-height:1.6;">A new question has been asked and is waiting to be claimed.</p>
  ...
  <p style="font-size:13px;color:#888;line-height:1.6;">
    If someone else claims it first, the link will still let you read the question.
  </p>
</body>
</html>