...
<body style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:40px 24px;color:#111;">
  ...
  <h1 style="font-size:22px;font-weight:700;margin:0 0 12px;">New creator application</h1>
  <p style="color:#444;line-height:1.6;">
    <strong>{{ $applicantName }}</strong> ({{ $applicantEmail }}) has applied to become a creator.
  </p>
